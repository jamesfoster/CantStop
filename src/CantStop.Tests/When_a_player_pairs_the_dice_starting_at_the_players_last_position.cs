namespace CantStop.Tests
{
	...
	public class When_a_player_pairs_the_dice_starting_at_the_players_last_position : Given_a_game_repository
	{
		...
		Establish that = () =>
			{
				...
				Game.Players.Add(new Player
					{
						Position = new[] {0, 0, 0, 0, 0, 3, 0, 4, 0, 0, 0}
					});
				Game.Players.Add(new Player());
		...
		It should_increment_climber_9 = () => Game.Climbers[9].ShouldEqual(5);
		It should_increment_climber_7 = () => Game.Climbers[7].ShouldEqual(4);

		It should_have_2_climbers = () => Game.Climbers.Count.ShouldEqual(2);
	}
}