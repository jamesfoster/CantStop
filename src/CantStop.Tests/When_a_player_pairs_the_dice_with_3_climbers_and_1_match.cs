namespace CantStop.Tests
{
	...
	public class When_a_player_pairs_the_dice_with_3_climbers_and_1_match : Given_a_game_repository
	{
				...
				Game = new Game
					{
						...
						CurrentPlayer = 1,
						Dice = dice,
						Climbers = new Dictionary<int, int> {{3, 1}, {4, 1}, {7, 1}}
					};
		...
		It should_increment_climber_7 = () => Game.Climbers[7].ShouldEqual(2);
